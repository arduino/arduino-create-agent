...
// ManageV1Controller implements the Manage_v1 resource.
type ManageV1Controller struct {
	*goa.Controller
	Version  string
	Revision string
}
...
func (c *ManageV1Controller) Info(ctx *app.InfoManageV1Context) error {
	return ctx.OK(&app.ArduinoAgentManageInfo{
		Version:  c.Version,
		Revision: c.Revision,
	})
}
