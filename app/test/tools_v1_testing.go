...
func ListToolsV1OK(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.ToolsV1Controller) (http.ResponseWriter, app.ArduinoAgentToolsToolCollection) {
	...
	if resp != nil {
		var _ok bool
		mt, _ok = resp.(app.ArduinoAgentToolsToolCollection)
		if !_ok {
			t.Fatalf("invalid response media: got variable of type %T, value %+v, expected instance of app.ArduinoAgentToolsToolCollection", resp, resp)
		}
		_err = mt.Validate()
		if _err != nil {
			t.Errorf("invalid response media type: %s", _err)
